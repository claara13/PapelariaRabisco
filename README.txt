...
# Projeto Integrador: CRUD Básico em Programação Web e API

## Descrição

Este é um projeto integrador entre as disciplinas de Programação Web Front-End,Programação Web Back-End e Banco de Dados. O projeto enfatiza a integração de tecnologias e conceitos aprendidos em ambas as disciplinas, incluindo o uso do Git e do GitHub para controle de versão, Flask como o framework back-end, MySQL e Python, e HTML/CSS com Bootstrap para o front-end, foi utilizado também REACT.
...
- REACT: A biblioteca front-end JavaScript de código aberto com foco em criar interfaces de usuário
...
1. **Clone o Repositório**:
   1. git clone: https://github.com/Juliagomes0910/projetoQuitanda.git
